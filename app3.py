...
def index():
    if request.method == 'POST':
        ...
        response, sentiment, aggresiveness, political_tendency, youtube_urls = rag.chain3(user_input)  # Example of calling a method from your class
        return render_template_string(HTML_TEMPLATE, result=response, sentiment=sentiment, aggresiveness=aggresiveness, political_tendency=political_tendency, youtube_urls=youtube_urls, input_value=user_input)
    return render_template_string(HTML_TEMPLATE, result=None, sentiment=None, aggresiveness=None, political_tendency=None, youtube_urls=[], input_value='')
...
<head>
    ...
    <style>
        ...
        .results-box, .sentiment-box, .youtube-box {
            display: inline-block; /* Makes the container inline for center alignment */
        ...
        .result-section, .sentiment-section, .youtube-section {
